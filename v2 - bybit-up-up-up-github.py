...
NAD_KOLKU_DA_OTIDE_PA_DA_KUPAM = 0
KOLKU_DA_SE_SIMNE_PA_DA_PRODADAM = 9
...
def make_order(symbol, side, qty, direct):
    ...
    telegram(f'order created up up up {symbol}, {side}, {qty}, {direct}')   
    ...
    try:
        ...
        if can_buy == False and can_sell == False:
            ...
            for spike in spike_results:
                ...
                print(spike)
                print('spike')
                if spike[2] == "down" and buy_before == True:
                    if smallest_price == 0:
                ...
                elif spike[2] == "up" and buy_before == False:
                    if last_max_price == 0:
            ...
            if smallest_price < 0 and buy_before == True and abs(smallest_price) >= KOLKU_DA_SE_SIMNE_PA_DA_PRODADAM:
                ...
                save_price_history(price_history)
                direct = 'down or up'
            elif last_max_price > 0 and buy_before == False and last_max_price >= NAD_KOLKU_DA_OTIDE_PA_DA_KUPAM:
        ...
        print(f"🔍 DEBUG: pred kupuvame prodavame can_buy= {can_buy} can_sell= {can_sell} buy_before= {buy_before}")
        if can_sell == True and can_buy == False and buy_before == True:
            #tuka prodavame
            ...
            can_buy = False
            can_sell = False
        elif can_sell == False and can_buy == True and buy_before == False:
            #tuka kupuvame
